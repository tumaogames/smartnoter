...
if ( TRACE ) { TRACE( "ButtonPulse#OnEnable", this ); }
                ...
                DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.TweenSettingsExtensions.SetLoops$1(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOScale(this.transform, this.scaleAmount, this.pulseDuration), -1, DG.Tweening.LoopType.Yoyo), DG.Tweening.Ease.InOutSine);
            },
...
if ( TRACE ) { TRACE( "CanvasGroupAnimator#TriggerAnimate", this ); }
            ...
            /*CanvasGroupAnimator.TriggerAnimateIn start.*/
            TriggerAnimateIn: function () {
if ( TRACE ) { TRACE( "CanvasGroupAnimator#TriggerAnimateIn", this ); }

                UnityEngine.Debug.Log$1("Triger Animate");
                DG.Tweening.TweenSettingsExtensions.SetLoops$1(DG.Tweening.Core.TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions), DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions), DG.Tweening.DOTweenModuleUI.DOFade(this.canvasGroup, 1, this.fadeDuration), this.fadeEaseType), this.isLooping ? -1 : 0, DG.Tweening.LoopType.Yoyo);
            },
            /*CanvasGroupAnimator.TriggerAnimateIn end.*/
...
if ( TRACE ) { TRACE( "DG.Tweening.DOTweenModuleUtils.Physics#CreateDOTweenPathTween", this ); }
    ...
    /*DragToResizeLeft start.*/
    Bridge.define("DragToResizeLeft", {
        ...
        fields: {
            ...
            handle$1: null,
            container: null,
            originalAnchorMin: null,
            originalAnchorMax: null,
            originalOffsetMin: null,
            originalOffsetMax: null,
            pointerOffsetX: 0
        },
        alias: [
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "DragToResizeLeft#init", this ); }

                this.originalAnchorMin = new UnityEngine.Vector2();
                this.originalAnchorMax = new UnityEngine.Vector2();
                this.originalOffsetMin = new UnityEngine.Vector2();
                this.originalOffsetMax = new UnityEngine.Vector2();
                this.minWidth = 100.0;
                this.pointerOffsetX = 0.0;
            }
        },
        methods: {
            /*DragToResizeLeft.Awake start.*/
            Awake: function () {
if ( TRACE ) { TRACE( "DragToResizeLeft#Awake", this ); }

                this.handle$1 = this.GetComponent(UnityEngine.RectTransform);

                if (UnityEngine.Component.op_Equality(this.target, null)) {
                    this.target = Bridge.as(this.handle$1.parent, UnityEngine.RectTransform);
                }

                if (UnityEngine.Component.op_Inequality(this.target, null)) {
                    this.container = Bridge.as(this.target.parent, UnityEngine.RectTransform);
                }
            },
            /*DragToResizeLeft.Awake end.*/

            /*DragToResizeLeft.OnBeginDrag start.*/
            OnBeginDrag: function (eventData) {
if ( TRACE ) { TRACE( "DragToResizeLeft#OnBeginDrag", this ); }

                if (GameManager.Instance.arrow.activeInHierarchy) {
                    GameManager.Instance.arrow.SetActive(false);
                }
                if (UnityEngine.Component.op_Equality(this.target, null) || UnityEngine.Component.op_Equality(this.container, null)) {
                    return;
                }

                // Cache original values
                this.originalAnchorMin = this.target.anchorMin.$clone();
                this.originalAnchorMax = this.target.anchorMax.$clone();
                this.originalOffsetMin = this.target.offsetMin.$clone();
                this.originalOffsetMax = this.target.offsetMax.$clone();
                var localMousePosInHandle = { v : new UnityEngine.Vector2() };

                if (UnityEngine.RectTransformUtility.ScreenPointToLocalPointInRectangle(this.handle$1, eventData.position, eventData.pressEventCamera, localMousePosInHandle)) {
                    this.pointerOffsetX = localMousePosInHandle.v.x;
                }
            },
            /*DragToResizeLeft.OnBeginDrag end.*/

            /*DragToResizeLeft.OnDrag start.*/
            OnDrag: function (eventData) {
if ( TRACE ) { TRACE( "DragToResizeLeft#OnDrag", this ); }
                ...
                if (!UnityEngine.RectTransformUtility.ScreenPointToLocalPointInRectangle(this.container, eventData.position, eventData.pressEventCamera, local)) {
                    return;
                }

                local.v.x += this.pointerOffsetX - 40.0;
                // 2. Convert local X into normalized [0,1] anchor value
                var containerWidth = this.container.rect.width;
                var leftEdge = -containerWidth * 0.5;
                var rightEdge = containerWidth * 0.5;

                var normalizedX = pc.math.inverseLerp(leftEdge, rightEdge, local.v.x);

                // 3. Clamp to avoid collapse
                // Compute the right anchor position in pixels
                var rightAnchorPos = this.originalAnchorMax.x * containerWidth + this.originalOffsetMax.x;
                var newLeftAnchorPos = pc.math.lerp(leftEdge, rightEdge, normalizedX);
                var width = rightAnchorPos - newLeftAnchorPos;

                if (width < this.minWidth) {
                    // Too narrow � clamp normalizedX to maintain minWidth
                    var minLeftPos = rightAnchorPos - this.minWidth;
                    normalizedX = pc.math.inverseLerp(leftEdge, rightEdge, minLeftPos);
                }

                // 4. Update anchorMin.x and keep offsetMin unchanged
                var anchorMin = this.target.anchorMin.$clone();
                anchorMin.x = Math.max(0, Math.min(1, normalizedX));
                this.target.anchorMin = anchorMin.$clone();

                // 5. Keep offsetMax the same (to preserve right edge)
                this.target.offsetMax = this.originalOffsetMax.$clone();
            },
            /*DragToResizeLeft.OnDrag end.*/

            /*DragToResizeLeft.OnEndDrag start.*/
            OnEndDrag: function (eventData) {
if ( TRACE ) { TRACE( "DragToResizeLeft#OnEndDrag", this ); }

                if (this.GetComponent(UnityEngine.RectTransform).localPosition.x <= -261.7079) {
                    UnityEngine.Debug.Log$1("right drop");
                    this.GetComponent(UnityEngine.RectTransform).localScale = new pc.Vec3( -1.0, 0.675, 1 );
                    this.GetComponent(UnityEngine.RectTransform).anchoredPosition = new pc.Vec2( 53.0, 99.0 );
                } else {
                    UnityEngine.Debug.Log$1("left drop");
                    this.GetComponent(UnityEngine.RectTransform).localScale = new pc.Vec3( 1.0, 0.675, 1 );
                    this.GetComponent(UnityEngine.RectTransform).anchoredPosition = new pc.Vec2( -32.6, 99.0 );
                }
            },
            /*DragToResizeLeft.OnEndDrag end.*/
    ...
    Bridge.define("GameManager", {
        ...
        fields: {
            ...
            CurrentState: 0,
            currentScore: 0,
            BodyToSummarize: null,
            SummarizedText: null,
            transcriptBtnBlue: null,
            transcriptBtn: null,
            summaryBtn: null,
            summaryBtnBlue: null,
            mainPanel: null,
...
if ( TRACE ) { TRACE( "GameManager#StartVoiceOver", this ); }
...
if ( TRACE ) { TRACE( "GameManager#SummarizeText1", this ); }
...
if ( TRACE ) { TRACE( "GameManager#SummarizeText", this ); }

                this.subTitle.GetComponent(SubtitleAuto).enabled = false;
                this.scrollBarVertical.GetComponent(UnityEngine.UI.Scrollbar).value = 1;
                ...
                TaskManager.Instance.RunAfter(0.1, Bridge.fn.bind(this, function () {
                    ...
                    this.BodyToSummarize.gameObject.SetActive(true);
...
if ( TRACE ) { TRACE( "StartClickHandler#EnableSound", this ); }
    ...
    /*SubtitleAuto start.*/
    Bridge.define("SubtitleAuto", {
        inherits: [UnityEngine.MonoBehaviour],
        statics: {
            methods: {
                /*SubtitleAuto.CountVisible:static start.*/
                CountVisible: function (s) {
if ( TRACE ) { TRACE( "SubtitleAuto#CountVisible", this ); }
                ...
                /*SubtitleAuto.CountVisible:static end.*/
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "SubtitleAuto#init", this ); }

                this.charsPerSecond = 45.0;
                this.loop = false;
                this.scrollMotion = SubtitleAuto.ScrollMotion.Duration;
                this.scrollSnapTime = 0.15;
                this.scrollSpeed = 6.0;
                this.linesPerStep = 1.0;
                this.topSafeMargin = 0.06;
                this.startAutoScrollAtLine = 0;
                this.manualScroll = false;
                this.manualScrollValue = 1.0;
                this._fullText = "";
            }
        },
        methods: {
            /*SubtitleAuto.Awake start.*/
            Awake: function () {
if ( TRACE ) { TRACE( "SubtitleAuto#Awake", this ); }

                if (UnityEngine.MonoBehaviour.op_Equality(this._label, null)) {
                    this._label = this.GetComponent(TMPro.TMP_Text);
                }
                if (UnityEngine.MonoBehaviour.op_Equality(this.scroll, null)) {
                    this.scroll = this.GetComponentInParent(UnityEngine.UI.ScrollRect);
                }
            },
            /*SubtitleAuto.Awake end.*/

            /*SubtitleAuto.OnEnable start.*/
            OnEnable: function () {
if ( TRACE ) { TRACE( "SubtitleAuto#OnEnable", this ); }

                this.StartPlayback();
            },
            /*SubtitleAuto.OnEnable end.*/

            /*SubtitleAuto.StartPlayback start.*/
            StartPlayback: function () {
if ( TRACE ) { TRACE( "SubtitleAuto#StartPlayback", this ); }

                this._running = UnityEngine.MonoBehaviour.op_Inequality(this._label, null) && this.lines != null && this.lines.length > 0;
                if (!this._running) {
                    if (UnityEngine.MonoBehaviour.op_Inequality(this._label, null)) {
                        this._label.text = "";
                        this._label.maxVisibleCharacters = 0;
                    }
                    return;
                }

                if (this.startAutoScrollAtLine < 0) {
                    this.startAutoScrollAtLine = 0;
                }
                if (this.startAutoScrollAtLine >= this.lines.length) {
                    this.startAutoScrollAtLine = (this.lines.length - 1) | 0;
                }

                this.BuildFullTextAndBoundaries();
                this._label.text = this._fullText;
                this.RebuildLayout();
                this._label.maxVisibleCharacters = 0;
                this._lastVisible = 0;

                this._idx = 0;
                this._t0 = UnityEngine.Time.time;
                this._holding = false;
                this._scrolling = false;

                this.SetScrollNormalized(1.0); // start at top
            },
            /*SubtitleAuto.StartPlayback end.*/

            /*SubtitleAuto.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "SubtitleAuto#Update", this ); }

                if (!this._running) {
                    if (this.manualScroll) {
                        this.ApplyManualScroll();
                    }
                    return;
                }
                if (this.manualScroll) {
                ...
                if (this._scrolling) {
                    this._scrollT += UnityEngine.Time.unscaledDeltaTime;
                    var u = this._scrollDur > 0.0 ? Math.max(0, Math.min(1, this._scrollT / this._scrollDur)) : 1.0;
                    var n = pc.math.lerp(this._scrollFrom, this._scrollTo, u);
                    this.SetScrollNormalized(n);
                    if (u >= 1.0) {
                        this._scrolling = false;
                    }
                }

                var baseCount = this._idx === 0 ? 0 : this._lineEnd[((this._idx - 1) | 0)];
                var target = this._lineEnd[this._idx];

                if (!this._holding) {
                    var typed = Bridge.Int.clip32((UnityEngine.Time.time - this._t0) * this.charsPerSecond + 0.5);
                    var remain = (target - baseCount) | 0;
                    var want = (baseCount + (typed >= remain ? remain : typed)) | 0;

                    if (want > this._label.maxVisibleCharacters) {
                        this._label.maxVisibleCharacters = want;
                        if (want > this._lastVisible) {
                            this._lastVisible = want;
                        }
                    }

                    if (want >= target) {
                        this._holding = true;
                        this._holdUntil = UnityEngine.Time.time + this.lines[this._idx].holdSeconds;
                    }
                } else {
                    if (UnityEngine.Time.time >= this._holdUntil) {
                        var ni = (this._idx + 1) | 0;
                        if (ni >= this.lines.length) {
                            if (!this.loop) {
                                this._running = false;
                                return;
                            }
                            ...
                            this._t0 = UnityEngine.Time.time;
                            this._holding = false;
                            this.SetScrollNormalized(1.0);
                            return;
                        }

                        if (ni >= this.startAutoScrollAtLine) {
                            this.ScrollFromNextLineBySteps(ni, this.linesPerStep);
                        }
            ...
            /*SubtitleAuto.Update end.*/

            /*SubtitleAuto.BuildFullTextAndBoundaries start.*/
            BuildFullTextAndBoundaries: function () {
if ( TRACE ) { TRACE( "SubtitleAuto#BuildFullTextAndBoundaries", this ); }

                var $t;
                var sb = new System.Text.StringBuilder("", 256);
                this._lineEnd = System.Array.init(this.lines.length, 0, System.Int32);
                ...
                for (var i = 0; i < this.lines.length; i = (i + 1) | 0) {
                    ...
                    var t = ($t = this.lines[i].text, $t != null ? $t : "");
                    sb.append(t);
                    acc = (acc + (SubtitleAuto.CountVisible(t))) | 0;
                    this._lineEnd[i] = acc;
                }
                this._fullText = sb.toString();
            },
            /*SubtitleAuto.BuildFullTextAndBoundaries end.*/

            /*SubtitleAuto.ScrollFromNextLineBySteps start.*/
            ScrollFromNextLineBySteps: function (nextIndex, stepLines) {
if ( TRACE ) { TRACE( "SubtitleAuto#ScrollFromNextLineBySteps", this ); }
                ...
                this.RebuildLayout();
                this._label.ForceMeshUpdate();

                var ti = this._label.textInfo;
                var totalLines = ti.lineCount;
                if (totalLines <= 1) {
                    this.SetScrollNormalized(1.0);
                    return;
                }

                var totalVis = ti.characterCount;
                if (totalVis <= 0) {
                    return;
                }

                var startChar = nextIndex === 0 ? 0 : this._lineEnd[((nextIndex - 1) | 0)];
                if (startChar >= totalVis) {
                    startChar = (totalVis - 1) | 0;
                }

                var nextStartLine = ti.characterInfo[startChar].lineNumber;

                var targetLineF = nextStartLine + (stepLines - 1.0);
                if (targetLineF < 0.0) {
                    targetLineF = 0.0;
                }
                var maxIdx = (totalLines - 1) | 0;
                if (targetLineF > maxIdx) {
                    targetLineF = maxIdx;
                }

                var frac = (maxIdx > 0.0) ? (targetLineF / maxIdx) : 1.0;
                var target = 1.0 - frac;
                target = Math.max(0, Math.min(1, target - this.topSafeMargin));

                this.BeginScrollTo(target);
            },
            /*SubtitleAuto.ScrollFromNextLineBySteps end.*/

            /*SubtitleAuto.BeginScrollTo start.*/
            BeginScrollTo: function (target) {
if ( TRACE ) { TRACE( "SubtitleAuto#BeginScrollTo", this ); }

                if (UnityEngine.MonoBehaviour.op_Equality(this.scroll, null)) {
                    return;
                }
                var current = this.scroll.verticalNormalizedPosition;
                target = Math.max(0, Math.min(1, target));

                if (this.scrollMotion === SubtitleAuto.ScrollMotion.Instant) {
                    this._scrolling = false;
                    this.SetScrollNormalized(target);
                    return;
                }

                if (this.scrollMotion === SubtitleAuto.ScrollMotion.Speed) {
                    var dist = Math.abs(target - current);
                    this._scrollDur = (this.scrollSpeed > 0.0) ? (dist / this.scrollSpeed) : 0.0;
                } else {
                    this._scrollDur = this.scrollSnapTime;
                }

                this._scrollFrom = current;
                this._scrollTo = target;
                this._scrollT = 0.0;
                this._scrolling = this._scrollDur > 0.0 && this._scrollFrom !== this._scrollTo;
                if (!this._scrolling) {
                    this.SetScrollNormalized(this._scrollTo);
                }
            },
            /*SubtitleAuto.BeginScrollTo end.*/

            /*SubtitleAuto.ApplyManualScroll start.*/
            ApplyManualScroll: function () {
if ( TRACE ) { TRACE( "SubtitleAuto#ApplyManualScroll", this ); }

                this.SetScrollNormalized(this.manualScrollValue);
            },
            /*SubtitleAuto.ApplyManualScroll end.*/

            /*SubtitleAuto.RebuildLayout start.*/
            RebuildLayout: function () {
if ( TRACE ) { TRACE( "SubtitleAuto#RebuildLayout", this ); }

                if (UnityEngine.MonoBehaviour.op_Inequality(this.scroll, null) && UnityEngine.Component.op_Inequality(this.scroll.content, null)) {
                    UnityEngine.UI.LayoutRebuilder.ForceRebuildLayoutImmediate(this.scroll.content);
                }
                UnityEngine.Canvas.ForceUpdateCanvases();
            },
            /*SubtitleAuto.RebuildLayout end.*/

            /*SubtitleAuto.SetScrollNormalized start.*/
            SetScrollNormalized: function (n) {
if ( TRACE ) { TRACE( "SubtitleAuto#SetScrollNormalized", this ); }

                if (UnityEngine.MonoBehaviour.op_Equality(this.scroll, null)) {
                    return;
                }
                n = (n < 0.0) ? 0.0 : (n > 1.0 ? 1.0 : n);
                this.scroll.verticalNormalizedPosition = n;

                if (UnityEngine.MonoBehaviour.op_Inequality(this.externalScrollbar, null)) {
                    this.externalScrollbar.value = (this.externalScrollbar.direction === UnityEngine.UI.Scrollbar.Direction.BottomToTop) ? n : (1.0 - n);
                }
            },
            /*SubtitleAuto.SetScrollNormalized end.*/
    ...
    /*SubtitleAuto+Line start.*/
    Bridge.define("SubtitleAuto.Line", {
        $kind: 1004,
        statics: {
            methods: {
                getDefaultValue: function () {
if ( TRACE ) { TRACE( "SubtitleAuto.Line#getDefaultValue", this ); }
 return new SubtitleAuto.Line(); }
            }
        },
        fields: {
            text: null,
        ...
        ctors: {
            ctor: function () {
if ( TRACE ) { TRACE( "SubtitleAuto.Line#ctor", this ); }
        ...
        methods: {
            getHashCode: function () {
if ( TRACE ) { TRACE( "SubtitleAuto.Line#getHashCode", this ); }

                var h = Bridge.addHash([1701734732, this.text, this.holdSeconds]);
                return h;
            },
            equals: function (o) {
if ( TRACE ) { TRACE( "SubtitleAuto.Line#equals", this ); }

                if (!Bridge.is(o, SubtitleAuto.Line)) {
                    return false;
                }
                return Bridge.equals(this.text, o.text) && Bridge.equals(this.holdSeconds, o.holdSeconds);
            },
            $clone: function (to) {
if ( TRACE ) { TRACE( "SubtitleAuto.Line#$clone", this ); }

                var s = to || new SubtitleAuto.Line();
                s.text = this.text;
                s.holdSeconds = this.holdSeconds;
                return s;
            }
        }
    });
    /*SubtitleAuto+Line end.*/

    /*SubtitleAuto+ScrollMotion start.*/
    Bridge.define("SubtitleAuto.ScrollMotion", {
        $kind: 1006,
        statics: {
            fields: {
                Instant: 0,
...
if ( TRACE ) { TRACE( "TaskSequencePro#RepeatRoutine", this ); }
    ...
    /*UIHorizontalDraggable start.*/
    Bridge.define("UIHorizontalDraggable", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "UIHorizontalDraggable#init", this ); }

                this.clampToParent = true;
                this.leftPadding = 0.0;
                this.rightPadding = 0.0;
            }
        },
        methods: {
            /*UIHorizontalDraggable.Awake start.*/
            Awake: function () {
if ( TRACE ) { TRACE( "UIHorizontalDraggable#Awake", this ); }

                this.rect = this.GetComponent(UnityEngine.RectTransform);
                this.parentRect = Bridge.as(this.rect.parent, UnityEngine.RectTransform);
            },
            /*UIHorizontalDraggable.Awake end.*/

            /*UIHorizontalDraggable.OnBeginDrag start.*/
            OnBeginDrag: function (eventData) {
if ( TRACE ) { TRACE( "UIHorizontalDraggable#OnBeginDrag", this ); }

                GameManager.Instance.arrow.SetActive(false);
                // Remember Y to lock vertical movement
                this.startY = this.rect.anchoredPosition.y;
                var localPoint = { v : new UnityEngine.Vector2() };

                // Get local pointer position relative to this rect to preserve grab offset
                if (UnityEngine.RectTransformUtility.ScreenPointToLocalPointInRectangle(this.rect, eventData.position, eventData.pressEventCamera, localPoint)) {
                    // distance from pivot to pointer along X
                    var pivotToLeft = this.rect.pivot.x * this.rect.rect.width;
                    this.pointerOffsetX = pivotToLeft - localPoint.v.x;
                }
            },
            /*UIHorizontalDraggable.OnBeginDrag end.*/

            /*UIHorizontalDraggable.OnDrag start.*/
            OnDrag: function (eventData) {
if ( TRACE ) { TRACE( "UIHorizontalDraggable#OnDrag", this ); }

                var parentLocal = { v : new UnityEngine.Vector2() };
                if (!UnityEngine.RectTransformUtility.ScreenPointToLocalPointInRectangle(this.parentRect, eventData.position, eventData.pressEventCamera, parentLocal)) {
                    return;
                }

                // Desired X inside parent space
                var targetX = parentLocal.v.x + this.pointerOffsetX;

                if (this.clampToParent) {
                    // Compute horizontal limits inside parent
                    var elemWidth = this.rect.rect.width;
                    var leftLimit = this.parentRect.rect.xMin + this.leftPadding + (this.rect.pivot.x * elemWidth);
                    var rightLimit = this.parentRect.rect.xMax - this.rightPadding - ((1.0 - this.rect.pivot.x) * elemWidth);
                    targetX = Math.max(leftLimit, Math.min(targetX, rightLimit));
                }

                this.rect.anchoredPosition = new pc.Vec2( targetX, this.startY ); // lock Y
            },
            /*UIHorizontalDraggable.OnDrag end.*/

            /*UIHorizontalDraggable.OnEndDrag start.*/
            OnEndDrag: function (eventData) {
if ( TRACE ) { TRACE( "UIHorizontalDraggable#OnEndDrag", this ); }
 },
            /*UIHorizontalDraggable.OnEndDrag end.*/


        }
    });
    /*UIHorizontalDraggable end.*/
...
if ( TRACE ) { TRACE( "AudioManager#FadeOutAndStop", this ); }
    ...
    var $m = Bridge.setMetadata,
        $n = ["System","System.Collections.Generic","UnityEngine","System.Collections","DG.Tweening","UnityEngine.EventSystems","TMPro","UnityEngine.UI","UnityEngine.Audio","DG.Tweening.Core","DG.Tweening.Plugins.Core.PathCore","System.Globalization","DG.Tweening.Plugins.Options"];
    ...
    /*SubtitleAuto start.*/
    $m("SubtitleAuto", function () { return {"nested":[SubtitleAuto.Line,SubtitleAuto.ScrollMotion],"att":1048833,"a":2,"at":[new UnityEngine.DisallowMultipleComponent(),new UnityEngine.RequireComponent.ctor(TMPro.TMP_Text)],"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"ApplyManualScroll","t":8,"sn":"ApplyManualScroll","rt":$n[0].Void},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":1,"n":"BeginScrollTo","t":8,"pi":[{"n":"target","pt":$n[0].Single,"ps":0}],"sn":"BeginScrollTo","rt":$n[0].Void,"p":[$n[0].Single]},{"a":1,"n":"BuildFullTextAndBoundaries","t":8,"sn":"BuildFullTextAndBoundaries","rt":$n[0].Void},{"a":1,"n":"CountVisible","is":true,"t":8,"pi":[{"n":"s","pt":$n[0].String,"ps":0}],"sn":"CountVisible","rt":$n[0].Int32,"p":[$n[0].String],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"OnEnable","t":8,"sn":"OnEnable","rt":$n[0].Void},{"a":1,"n":"RebuildLayout","t":8,"sn":"RebuildLayout","rt":$n[0].Void},{"a":1,"n":"ScrollFromNextLineBySteps","t":8,"pi":[{"n":"nextIndex","pt":$n[0].Int32,"ps":0},{"n":"stepLines","pt":$n[0].Single,"ps":1}],"sn":"ScrollFromNextLineBySteps","rt":$n[0].Void,"p":[$n[0].Int32,$n[0].Single]},{"a":1,"n":"SetScrollNormalized","t":8,"pi":[{"n":"n","pt":$n[0].Single,"ps":0}],"sn":"SetScrollNormalized","rt":$n[0].Void,"p":[$n[0].Single]},{"a":2,"n":"StartPlayback","t":8,"sn":"StartPlayback","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":1,"n":"_fullText","t":4,"rt":$n[0].String,"sn":"_fullText"},{"a":1,"n":"_holdUntil","t":4,"rt":$n[0].Single,"sn":"_holdUntil","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"_holding","t":4,"rt":$n[0].Boolean,"sn":"_holding","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"_idx","t":4,"rt":$n[0].Int32,"sn":"_idx","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"_label","t":4,"rt":$n[6].TMP_Text,"sn":"_label"},{"a":1,"n":"_lastVisible","t":4,"rt":$n[0].Int32,"sn":"_lastVisible","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"_lineEnd","t":4,"rt":$n[0].Array.type(System.Int32),"sn":"_lineEnd"},{"a":1,"n":"_running","t":4,"rt":$n[0].Boolean,"sn":"_running","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"_scrollDur","t":4,"rt":$n[0].Single,"sn":"_scrollDur","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"_scrollFrom","t":4,"rt":$n[0].Single,"sn":"_scrollFrom","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"_scrollT","t":4,"rt":$n[0].Single,"sn":"_scrollT","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"_scrollTo","t":4,"rt":$n[0].Single,"sn":"_scrollTo","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"_scrolling","t":4,"rt":$n[0].Boolean,"sn":"_scrolling","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"_t0","t":4,"rt":$n[0].Single,"sn":"_t0","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.HeaderAttribute("Playback"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"charsPerSecond","t":4,"rt":$n[0].Single,"sn":"charsPerSecond","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"externalScrollbar","t":4,"rt":$n[7].Scrollbar,"sn":"externalScrollbar"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"lines","t":4,"rt":System.Array.type(SubtitleAuto.Line),"sn":"lines"},{"at":[new UnityEngine.SerializeFieldAttribute(),new UnityEngine.RangeAttribute(0.25, 5.0)],"a":1,"n":"linesPerStep","t":4,"rt":$n[0].Single,"sn":"linesPerStep","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"loop","t":4,"rt":$n[0].Boolean,"sn":"loop","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HeaderAttribute("Inspector Control"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"manualScroll","t":4,"rt":$n[0].Boolean,"sn":"manualScroll","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.SerializeFieldAttribute(),new UnityEngine.RangeAttribute(0.0, 1.0)],"a":1,"n":"manualScrollValue","t":4,"rt":$n[0].Single,"sn":"manualScrollValue","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.HeaderAttribute("Auto-Scroll"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"scroll","t":4,"rt":$n[7].ScrollRect,"sn":"scroll"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"scrollMotion","t":4,"rt":SubtitleAuto.ScrollMotion,"sn":"scrollMotion","box":function ($v) { return Bridge.box($v, SubtitleAuto.ScrollMotion, System.Enum.toStringFn(SubtitleAuto.ScrollMotion));}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"scrollSnapTime","t":4,"rt":$n[0].Single,"sn":"scrollSnapTime","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"scrollSpeed","t":4,"rt":$n[0].Single,"sn":"scrollSpeed","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"startAutoScrollAtLine","t":4,"rt":$n[0].Int32,"sn":"startAutoScrollAtLine","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.SerializeFieldAttribute(),new UnityEngine.RangeAttribute(0.0, 0.5)],"a":1,"n":"topSafeMargin","t":4,"rt":$n[0].Single,"sn":"topSafeMargin","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*SubtitleAuto end.*/

    /*SubtitleAuto+Line start.*/
    $m("SubtitleAuto.Line", function () { return {"td":SubtitleAuto,"att":1057034,"a":2,"at":[new System.SerializableAttribute()],"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"holdSeconds","t":4,"rt":$n[0].Single,"sn":"holdSeconds","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.TextAreaAttribute.$ctor1(2, 4)],"a":2,"n":"text","t":4,"rt":$n[0].String,"sn":"text"}]}; }, $n);
    /*SubtitleAuto+Line end.*/

    /*SubtitleAuto+ScrollMotion start.*/
    $m("SubtitleAuto.ScrollMotion", function () { return {"td":SubtitleAuto,"att":258,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Duration","is":true,"t":4,"rt":SubtitleAuto.ScrollMotion,"sn":"Duration","box":function ($v) { return Bridge.box($v, SubtitleAuto.ScrollMotion, System.Enum.toStringFn(SubtitleAuto.ScrollMotion));}},{"a":2,"n":"Instant","is":true,"t":4,"rt":SubtitleAuto.ScrollMotion,"sn":"Instant","box":function ($v) { return Bridge.box($v, SubtitleAuto.ScrollMotion, System.Enum.toStringFn(SubtitleAuto.ScrollMotion));}},{"a":2,"n":"Speed","is":true,"t":4,"rt":SubtitleAuto.ScrollMotion,"sn":"Speed","box":function ($v) { return Bridge.box($v, SubtitleAuto.ScrollMotion, System.Enum.toStringFn(SubtitleAuto.ScrollMotion));}}]}; }, $n);
    /*SubtitleAuto+ScrollMotion end.*/
    ...
    /*UIHorizontalDraggable start.*/
    $m("UIHorizontalDraggable", function () { return {"att":1048577,"a":2,"at":[new UnityEngine.RequireComponent.ctor(UnityEngine.RectTransform)],"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":2,"n":"OnBeginDrag","t":8,"pi":[{"n":"eventData","pt":$n[5].PointerEventData,"ps":0}],"sn":"OnBeginDrag","rt":$n[0].Void,"p":[$n[5].PointerEventData]},{"a":2,"n":"OnDrag","t":8,"pi":[{"n":"eventData","pt":$n[5].PointerEventData,"ps":0}],"sn":"OnDrag","rt":$n[0].Void,"p":[$n[5].PointerEventData]},{"a":2,"n":"OnEndDrag","t":8,"pi":[{"n":"eventData","pt":$n[5].PointerEventData,"ps":0}],"sn":"OnEndDrag","rt":$n[0].Void,"p":[$n[5].PointerEventData]},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"clampToParent","t":4,"rt":$n[0].Boolean,"sn":"clampToParent","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"leftPadding","t":4,"rt":$n[0].Single,"sn":"leftPadding","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"parentRect","t":4,"rt":$n[2].RectTransform,"sn":"parentRect"},{"a":1,"n":"pointerOffsetX","t":4,"rt":$n[0].Single,"sn":"pointerOffsetX","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"rect","t":4,"rt":$n[2].RectTransform,"sn":"rect"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"rightPadding","t":4,"rt":$n[0].Single,"sn":"rightPadding","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"startY","t":4,"rt":$n[0].Single,"sn":"startY","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*UIHorizontalDraggable end.*/
    ...
    /*DG.Tweening.DOTweenModuleUI start.*/
    $m("DG.Tweening.DOTweenModuleUI", function () { return {"nested":[$n[4].DOTweenModuleUI.Utils],"att":1048961,"a":2,"s":true,"m":[{"a":2,"n":"DOAnchorMax","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorMax","rt":$n[9].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[2].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorMin","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorMin","rt":$n[9].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[2].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos","rt":$n[9].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[2].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos3D","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[2].Vector3,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos3D","rt":$n[9].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[2].Vector3,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos3DX","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos3DX","rt":$n[9].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos3DY","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos3DY","rt":$n[9].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos3DZ","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos3DZ","rt":$n[9].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPosX","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPosX","rt":$n[9].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPosY","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPosY","rt":$n[9].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOBlendableColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].Graphic,"ps":0},{"n":"endValue","pt":$n[2].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOBlendableColor","rt":$n[4].Tweener,"p":[$n[7].Graphic,$n[2].Color,$n[0].Single]},{"a":2,"n":"DOBlendableColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].Image,"ps":0},{"n":"endValue","pt":$n[2].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOBlendableColor$1","rt":$n[4].Tweener,"p":[$n[7].Image,$n[2].Color,$n[0].Single]},{"a":2,"n":"DOBlendableColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].Text,"ps":0},{"n":"endValue","pt":$n[2].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOBlendableColor$2","rt":$n[4].Tweener,"p":[$n[7].Text,$n[2].Color,$n[0].Single]},{"a":2,"n":"DOColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].Graphic,"ps":0},{"n":"endValue","pt":$n[2].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOColor","rt":$n[9].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[7].Graphic,$n[2].Color,$n[0].Single]},{"a":2,"n":"DOColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].Image,"ps":0},{"n":"endValue","pt":$n[2].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOColor$1","rt":$n[9].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[7].Image,$n[2].Color,$n[0].Single]},{"a":2,"n":"DOColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].Outline,"ps":0},{"n":"endValue","pt":$n[2].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOColor$2","rt":$n[9].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[7].Outline,$n[2].Color,$n[0].Single]},{"a":2,"n":"DOColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].Text,"ps":0},{"n":"endValue","pt":$n[2].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOColor$3","rt":$n[9].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[7].Text,$n[2].Color,$n[0].Single]},{"a":2,"n":"DOCounter","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].Text,"ps":0},{"n":"fromValue","pt":$n[0].Int32,"ps":1},{"n":"endValue","pt":$n[0].Int32,"ps":2},{"n":"duration","pt":$n[0].Single,"ps":3},{"n":"addThousandsSeparator","dv":true,"o":true,"pt":$n[0].Boolean,"ps":4},{"n":"culture","dv":null,"o":true,"pt":$n[11].CultureInfo,"ps":5}],"sn":"DOCounter","rt":$n[9].TweenerCore$3(System.Int32,System.Int32,DG.Tweening.Plugins.Options.NoOptions),"p":[$n[7].Text,$n[0].Int32,$n[0].Int32,$n[0].Single,$n[0].Boolean,$n[11].CultureInfo]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].CanvasGroup,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade","rt":$n[9].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[2].CanvasGroup,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].Graphic,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade$1","rt":$n[9].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[7].Graphic,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].Image,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade$2","rt":$n[9].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[7].Image,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].Outline,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade$3","rt":$n[9].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[7].Outline,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].Text,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade$4","rt":$n[9].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[7].Text,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFillAmount","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].Image,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFillAmount","rt":$n[9].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[7].Image,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFlexibleSize","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].LayoutElement,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOFlexibleSize","rt":$n[9].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[7].LayoutElement,$n[2].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOGradientColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].Image,"ps":0},{"n":"gradient","pt":pc.ColorGradient,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOGradientColor","rt":$n[4].Sequence,"p":[$n[7].Image,pc.ColorGradient,$n[0].Single]},{"a":2,"n":"DOHorizontalNormalizedPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].ScrollRect,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOHorizontalNormalizedPos","rt":$n[4].Tweener,"p":[$n[7].ScrollRect,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOJumpAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"jumpPower","pt":$n[0].Single,"ps":2},{"n":"numJumps","pt":$n[0].Int32,"ps":3},{"n":"duration","pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5}],"sn":"DOJumpAnchorPos","rt":$n[4].Sequence,"p":[$n[2].RectTransform,$n[2].Vector2,$n[0].Single,$n[0].Int32,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMinSize","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].LayoutElement,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMinSize","rt":$n[9].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[7].LayoutElement,$n[2].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DONormalizedPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].ScrollRect,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DONormalizedPos","rt":$n[4].Tweener,"p":[$n[7].ScrollRect,$n[2].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOPivot","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOPivot","rt":$n[9].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[2].Vector2,$n[0].Single]},{"a":2,"n":"DOPivotX","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOPivotX","rt":$n[9].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOPivotY","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOPivotY","rt":$n[9].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOPreferredSize","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].LayoutElement,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOPreferredSize","rt":$n[9].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[7].LayoutElement,$n[2].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOPunchAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"punch","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"vibrato","dv":10,"o":true,"pt":$n[0].Int32,"ps":3},{"n":"elasticity","dv":1.0,"o":true,"pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5}],"sn":"DOPunchAnchorPos","rt":$n[4].Tweener,"p":[$n[2].RectTransform,$n[2].Vector2,$n[0].Single,$n[0].Int32,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOScale","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].Outline,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOScale","rt":$n[9].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[7].Outline,$n[2].Vector2,$n[0].Single]},{"a":2,"n":"DOShakeAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"duration","pt":$n[0].Single,"ps":1},{"n":"strength","dv":100.0,"o":true,"pt":$n[0].Single,"ps":2},{"n":"vibrato","dv":10,"o":true,"pt":$n[0].Int32,"ps":3},{"n":"randomness","dv":90.0,"o":true,"pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5},{"n":"fadeOut","dv":true,"o":true,"pt":$n[0].Boolean,"ps":6},{"n":"randomnessMode","dv":0,"o":true,"pt":$n[4].ShakeRandomnessMode,"ps":7}],"sn":"DOShakeAnchorPos","rt":$n[4].Tweener,"p":[$n[2].RectTransform,$n[0].Single,$n[0].Single,$n[0].Int32,$n[0].Single,$n[0].Boolean,$n[0].Boolean,$n[4].ShakeRandomnessMode]},{"a":2,"n":"DOShakeAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"duration","pt":$n[0].Single,"ps":1},{"n":"strength","pt":$n[2].Vector2,"ps":2},{"n":"vibrato","dv":10,"o":true,"pt":$n[0].Int32,"ps":3},{"n":"randomness","dv":90.0,"o":true,"pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5},{"n":"fadeOut","dv":true,"o":true,"pt":$n[0].Boolean,"ps":6},{"n":"randomnessMode","dv":0,"o":true,"pt":$n[4].ShakeRandomnessMode,"ps":7}],"sn":"DOShakeAnchorPos$1","rt":$n[4].Tweener,"p":[$n[2].RectTransform,$n[0].Single,$n[2].Vector2,$n[0].Int32,$n[0].Single,$n[0].Boolean,$n[0].Boolean,$n[4].ShakeRandomnessMode]},{"a":2,"n":"DOShapeCircle","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"center","pt":$n[2].Vector2,"ps":1},{"n":"endValueDegrees","pt":$n[0].Single,"ps":2},{"n":"duration","pt":$n[0].Single,"ps":3},{"n":"relativeCenter","dv":false,"o":true,"pt":$n[0].Boolean,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5}],"sn":"DOShapeCircle","rt":$n[9].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.CircleOptions),"p":[$n[2].RectTransform,$n[2].Vector2,$n[0].Single,$n[0].Single,$n[0].Boolean,$n[0].Boolean]},{"a":2,"n":"DOSizeDelta","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOSizeDelta","rt":$n[9].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[2].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOText","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].Text,"ps":0},{"n":"endValue","pt":$n[0].String,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"richTextEnabled","dv":true,"o":true,"pt":$n[0].Boolean,"ps":3},{"n":"scrambleMode","dv":0,"o":true,"pt":$n[4].ScrambleMode,"ps":4},{"n":"scrambleChars","dv":null,"o":true,"pt":$n[0].String,"ps":5}],"sn":"DOText","rt":$n[9].TweenerCore$3(System.String,System.String,DG.Tweening.Plugins.Options.StringOptions),"p":[$n[7].Text,$n[0].String,$n[0].Single,$n[0].Boolean,$n[4].ScrambleMode,$n[0].String]},{"a":2,"n":"DOValue","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].Slider,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOValue","rt":$n[9].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[7].Slider,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOVerticalNormalizedPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].ScrollRect,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOVerticalNormalizedPos","rt":$n[4].Tweener,"p":[$n[7].ScrollRect,$n[0].Single,$n[0].Single,$n[0].Boolean]}]}; }, $n);
    /*DG.Tweening.DOTweenModuleUI end.*/
